  ...
  return (
    <div className="bg-[#fcfdfa] min-h-screen font-sans text-gray-800">
      <Helmet>
        ...
        <meta name="twitter:title" content="Contact Us | Sree Krishna Botanicals" />
        <meta name="twitter:description" content="Contact us for bulk oleoresin quotes, custom extracts, and export partnerships from India." />
      </Helmet>
